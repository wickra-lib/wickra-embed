<!--
Thanks for contributing to Wickra Embed!
...
- [ ] Rust crate (`crates/embed-core`)
- [ ] C ABI (`bindings/c`)
- [ ] Bare-metal targets (`thumbv7em-none-eabihf`, `thumbv6m-none-eabi`)
- [ ] Examples / docs
...
- [ ] Output matches an existing reference (TA-Lib, paper, prior Wickra Embed release) within documented tolerance
